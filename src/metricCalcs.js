...
var calcBusFactor = function (commitActivity) {
    var totalCommits = commitActivity.reduce(function (sum, contributor) { return sum + contributor.total; }, 0);
    ...
    for (var i = commitActivity.length - 1; i >= 0; i--) {
